...
CREATE TABLE public.patient (
    ...
    email text,
    "careGiverEmail" text,
    "phoneCountryCode" text DEFAULT '+1'::text,
    "phoneNumber" text,
    "careGiverPhoneNumber" text,
    "careGiverPhoneCountryCode" text DEFAULT '+1'::text
);
...
COMMENT ON TABLE public.session_type IS 'enums for session';
...
ALTER TABLE ONLY public.session_type
    ADD CONSTRAINT session_type_description_key UNIQUE (description);
ALTER TABLE ONLY public.session_type
    ADD CONSTRAINT session_type_pkey PRIMARY KEY (name);
...
ALTER TABLE ONLY public.session
    ADD CONSTRAINT session_status_fkey FOREIGN KEY (status) REFERENCES public.session_type(name) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ONLY public.subscription
